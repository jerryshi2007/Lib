...
namespace Lib.Web.Security
{
    public class LibAuthenticationTicket : ILibAuthenticationTicket
    {
        ...
        public LibAuthenticationTicket(ILibAuthenticationTicket ticket)
        {
            ...
            this.LoginTimeout = LibAuthenticationConfig.SlidingExpiration ? DateTime.Now.AddMinutes(LibAuthenticationConfig.CookieTimeout) : ticket.LoginTimeout;
        ...
        public LibAuthenticationTicket(ILoginUser loginUser, bool isPersistent)
        {
            ...
            this.loginTimeout = this.loginTime.AddMinutes((double)LibAuthenticationConfig.CookieTimeout);
