...
namespace Lib.Web.Json
{
    public class JsonHelper
    {
        ...
        {
            ExceptionHelper.FalseThrow(typeof(JavaScriptConverter).IsAssignableFrom(converterType), "未继承JavaScriptConveter继承");
            ...
            if (input != null)
            {
                ...
                else
                {
                    if (!(input is ValueType) && !(input is string) && !(input is IDictionary))
                    {
                        ...
                        {
                            result = InnerPreSerializeObject(input, type, resolverTypeLevel);
                        }
                    }
                }
            }
        ...
        public static Dictionary<string, object> InnerPreSerializeObject(object input, Type type, int resolverTypeLevel)
        {
