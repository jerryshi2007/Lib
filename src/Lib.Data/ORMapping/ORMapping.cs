...
namespace Lib.Data
{
    ...
    public static partial class ORMapping
    {
        ...
        public static SelectSqlClauseBuilder GetSelectSqlClauseBuilder<T>(ISqlBuilder builder, params string[] ignorProperties)
        {
            ORMappingItemCollection mapping = InnerGetMappingInfo(typeof(T));
            return GetSelectSqlClauseBuilder(mapping, ignorProperties);
        }

        public static string GetSelectFields<T>(ISqlBuilder builder, params string[] ignorProperties)
        {
            return GetSelectFields(typeof(T), builder, ignorProperties);
        }
        ...
        private static string GetSelectSql(ORMappingItemCollection mapping, ISqlBuilder builder, string[] ignorProperties)
        {
        ...
        private static SelectSqlClauseBuilder GetSelectSqlClauseBuilder(ORMappingItemCollection mapping, params string[] ignorProperties)
        {
            ExceptionHelper.FalseThrow<ArgumentNullException>(mapping != null, "mapping");
