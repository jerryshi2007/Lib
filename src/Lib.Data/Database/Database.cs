...
namespace Lib.Data
{
    ...
    public abstract class Database
    {
        ...
        /// <param name="parameters">存储过程参数赋值</param>
        /// <returns>查询结果</returns>
        public virtual DataSet ExecuteDataSet(string storedProcedureName, params DbParameter[] parameters)
        {
            return ExecuteDataSet(storedProcedureName, new string[] { SystemCreatedTableNameRoot }, parameters);
        }
        ...
        /// <param name="parameters">存储过程参数赋值</param>
        /// <returns>查询结果</returns>
        public virtual DataSet ExecuteDataSet(string storedProcedureName, string[] tableNames, params DbParameter[] parameters)
        {
            using (DbCommand command = CreateCommandByCommandType(CommandType.StoredProcedure, storedProcedureName, parameters))
            {
        ...
        internal DataSet ExecuteDataSet(CommandType commandType, string commandText, string[] tableNames, params DbParameter[] parameters)
        {
            return ExecuteDataSet(commandType, commandText, 0, 0, tableNames, parameters);
        }
        ...
        /// <returns>查询结果</returns>
        /// <remarks>该方法Oracle不支持， 如果需要查询返回多个DataTable请将其写成存储过程</remarks>
        public virtual DataSet ExecuteDataSet(CommandType commandType, string commandText, int pageNo, int pageSize, string[] tableNames, params DbParameter[] parameters)
        {
            using (DbCommand command = CreateCommandByCommandType(commandType, commandText, parameters))
            {
        ...
        public virtual DataSet ExecuteDataSet(DbCommand command, int pageNo, int pageSize, params string[] tableNames)
        {
            ...
            DoLoadDataSet(command, dataSet, pageNo, pageSize, tableNames);
            return dataSet;
        }
        ...
        /// <param name="parameters">存储过程参数赋值</param>
        /// <returns>单值</returns>
        public virtual object ExecuteScalar(string storedProcedureName, params DbParameter[] parameters)
        {
            return ExecuteScalar(CommandType.StoredProcedure, storedProcedureName, parameters);
        }

        public virtual object ExecuteScalar(CommandType commandType, string commandText, DbParameter[] dbParams)
        {
            using (DbCommand command = CreateCommandByCommandType(commandType, commandText, dbParams))
            {
        ...
        public virtual DbDataReader ExecuteReader(CommandType commandType, string commandText)
        {
        ...
        /// <returns>DataReader对象</returns>
        public virtual DbDataReader ExecuteReader(string storedProcedureName, params DbParameter[] parameters)
        {
            return ExecuteReader(CommandType.StoredProcedure, storedProcedureName, parameters);
        }
        ...
        protected virtual DbDataReader DoExecuteReader(DbCommand command)
        {
        ...
        public virtual int ExecuteNonQuery(string storedProcedureName, params DbParameter[] parameters)
        {
        ...
        ///// </summary>
        ///// <param name="storedProcedureName">存储过程名称</param>
        ///// <param name="parameters">对应的一组参数赋值</param>
        ...
        //public virtual DbCommand InitStoredProcedureCommand(string storedProcedureName, params DbParameter[] parameters)
        //{
        ...
        //    ExceptionHelper.FalseThrow<InvalidOperationException>(SameNumberOfParametersAndValues(command, parameters), "parameterValues");
        ...
        protected virtual void AssignParameterValues(DbCommand command, params DbParameter[] parameters)
        {
            ...
            if(parameters != null && parameters.Count() > 0)
            {
                ...
                {
                    AddParameter(command, param.ParameterName, param.DbType, param.Direction, String.Empty, DataRowVersion.Default, param.Value);
                }
            }
        }
        ...
        protected DbCommand CreateCommandByCommandType(CommandType commandType, string commandText, DbParameter[] parameters)
        {
