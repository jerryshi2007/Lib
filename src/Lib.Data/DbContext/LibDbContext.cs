...
namespace Lib.Data
{
    internal class LibDbContext : DbContext
    {
        ...
        /// </remarks>
        /// </summary>
        private const string NamePrefix = "Lib.Context";
        ...
        public LibDbContext(string name, bool autoClose)
        {
        ...
        protected static GraphWithoutTransaction StaticGraphWithoutTx
        {
            get
            {
                ...
                if (EnvironmentHelper.Mode == InstanceMode.Web)
                    ...
                    result = LibDbContext.graphWithoutTx;
                ...
                if (result == null)
                {
                    ...
                    if (EnvironmentHelper.Mode == InstanceMode.Web)
                        ...
                        LibDbContext.graphWithoutTx = result;
                }
